                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        ...
                                                        <input type="text" class="form-control" name="nombre" value="{{old('nombre')}}" placeholder="Escribe aqui..." required>
                            ...
                            <td>
                                <div class="row d-flex justify-center">
                                    ...
                                    <form action="{{ url('/admin/niveles/'.$nivel->id) }}" method="POST" id="miFormulario{{ $nivel->id }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm delete-btn ml-2" data-id="{{ $nivel->id }}">
                                ...
                                <div class="modal fade" id="ModalUpdate{{ $nivel->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Edición de un nivel</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                                ...
                                                <form action="{{ url('/admin/niveles/'.$nivel->id) }}" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-layer-group"></i></span>
                                                            <input type="text" class="form-control" name="nombre" value="{{ $nivel->nombre }}" placeholder="Escribe aquí..." required>
                                                        </div>
                                                        @error('nombre')
                                                        <small style="color: red">{{ $message }}</small>
                                                        @enderror
